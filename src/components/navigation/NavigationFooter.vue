  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        ...
        <p>Pixel is a free and open source Bootstrap 5 UI Kit that will help you prototype and build
          beautiful website pages and applications.</p>
        <ul class="social-buttons mb-5 mb-lg-0">
          ...
          <li>
            <a href="https://dribbble.com/themesberg" class="icon-white"
