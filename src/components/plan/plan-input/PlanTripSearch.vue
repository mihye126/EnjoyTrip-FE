        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <select
              ...
              v-model="selectSido"
            >
              <option v-for="(sido, index) in sidos" :key="index" :value="`${sido.code}`">
                {{ sido.name }}
              </option>
            </select>
          </div>
  ...
  export default {
    ...
    methods: {
      serch: async function () {
        ...
        const param1 = this.selectSido;
        const param2 = this.selectcontentTypeID;
        const param3 = this.selectkeyword;
