                ...
                <div class="row justify-content-center mb-5 mb-lg-6">
                    ...
                    <div class="row justify-content-center mb-5 mb-lg-6">
                        ...
                        <div class="col-lg-8" v-if="trips.length">
                            <plan-map v-model="trips" :trips="getTrips"></plan-map>
                        </div>
                        <div class="col-lg-4">
...
export default {
    ...
    methods: {
        ...
        //     this.trip_ids.forEach(id => {
        //         this.$store.dispatch("tripDetailStore/TripDetailinfo", id)
        //         let trip = { ...this.$store.state.tripDetailStore.attraction }
        //         console.log(id, trip)
